...
<body>
    <div class="kontainer">
        ...
        //var_dump ($adjective , $verbIng , $food , $noun , $number , $bodyPart);
        
        if ($adjective && $verbIng && $food && $noun && $number && $bodyPart) {
            
            $verben = ["eat", "love", "walk", "run", "cope", "stare", "laugh", "giggle", "swim", "kick", "punch", "yeet", "kill", "watch", "cook", "shoot", "murder", "chug", "sail", "drive"];
            ...
            <p><strong>Luigi:</strong> You're right about that, dear $noun. I hope you're ready to " . $verben[rand(0,20)] . ".</p>
            <p><strong>Mario:</strong> Ready? I've waited $number years to " . $verben[rand(0,20)] . " that scounderel Bowser!</p>
            <p><strong>Luigi:</strong> Pipe down. He has $bodyPart everywhere.</p>
            <p><strong>Mario:</strong> First, I'll " . $verben[rand(0,20)] . " and grab a/an $food. That'll give me $noun.</p>";
        }
        ?>
    </div>
</body>
